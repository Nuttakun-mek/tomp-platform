...
export const mobileCopy = {
  th: {
    ...
    openJob: "เปิดข้อมูลงาน",
    manualEntry: "กรอกลิงก์สำรอง",
    hideManualEntry: "ซ่อนลิงก์สำรอง",
    logoutJob: "ออกจากงาน",
    reload: "รีเฟรช",
  ...
  en: {
    ...
    openJob: "Open assignment",
    manualEntry: "Backup link",
    hideManualEntry: "Hide backup link",
    logoutJob: "Leave job",
    reload: "Reload",
