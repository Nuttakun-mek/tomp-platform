...
const TOOLS = [
  ...
  { href: "/superadmin/dev-tools/apple-review", label: "งานสาธิตสำหรับ Apple", detail: "สร้าง QR ถาวรให้ผู้ตรวจ App Review ใช้งานได้ครบทุกฟังก์ชัน ซ่อนจากรายการโครงการ", icon: Apple }
];
