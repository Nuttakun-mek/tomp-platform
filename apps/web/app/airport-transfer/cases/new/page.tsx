...
import { getAirportTransferProjectOptions } from "@/lib/airport-transfer/data";

export default async function NewAirportTransferCasePage() {
  const projectOptions = await getAirportTransferProjectOptions();
  return (
    <>
      ...
      <CreateAirportTransferCaseForm projectOptions={projectOptions} />
    </>
  );
}
