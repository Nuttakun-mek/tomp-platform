  ...
  return (
    <section className="enterprise-panel p-5">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <p className="text-[11px] font-bold tracking-[0.18em] text-operation">OPERATIONS PULSE</p>
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-5">
        {items.map((item) => (
          <article key={item.label} className="rounded-2xl border border-slate-200 bg-slate-50/80 p-4">
