...
export function DriverAccessQrPlaceholder({ accessUrl }: DriverAccessQrPlaceholderProps) {
  return (
    <section className="rounded-md border border-dashed border-slate-300 bg-white p-5 shadow-sm">
      <p className="text-sm font-semibold uppercase tracking-wide text-operation">Sprint 7 placeholder</p>
      ...
      <p className="mt-2 text-xs leading-5 text-slate-500">Production token validation, expiry, and revocation are deferred.</p>
    </section>
  );
}
