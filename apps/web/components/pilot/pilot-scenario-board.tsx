export function PilotScenarioBoard({ projectCode }: { projectCode: string }) {
  return (
    <section className="rounded-md border border-slate-200 bg-slate-950 p-4 text-white shadow-command">
      <p className="text-xs font-semibold uppercase tracking-[0.16em] text-teal-200">ชุดทดสอบ Pilot</p>
